...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/RocketNodeInc/go-ceph) [![license](http://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/ceph/go-ceph/master/LICENSE)
...
```sh
go get github.com/RocketNodeInc/go-ceph
```
...
<https://pkg.go.dev/github.com/RocketNodeInc/go-ceph>.
...
docker run --rm -it --net=host \
  ...
  -v ${PWD}:/go/src/github.com/RocketNodeInc/go-ceph:z \
...
* Have a question, comment, or feedback:
  [Use the Discussions Board](https://github.com/RocketNodeInc/go-ceph/discussions)
* Report an issue or request a feature:
  [Issues Tracker](https://github.com/RocketNodeInc/go-ceph/issues)
